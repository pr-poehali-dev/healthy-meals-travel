      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <section className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed">
            Даже во время длительных поездок на поезде не обязательно сбивать свое питание и питаться лапшой быстрого приготовления и сухим пюре с сосисками. Я подготовила для вас <span className="font-semibold text-foreground">5 простых рецептов</span> полезной еды. Готовятся быстро и насыщают надолго!
          </p>
